...
# open_resource() opens a file relative to the reliquary package, which is useful since you won’t necessarily know where that location is when deploying the application later. 
...
# You can read https://flask.palletsprojects.com/en/1.1.x/cli/#cli to learn more about writing commands.
